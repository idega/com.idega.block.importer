...
/**
 * <p>
 * TODO laddi Describe Type FileTypeHandler
 * </p>
 ...
 */
public class FileTypeHandler implements ICPropertyHandler {
	...
	public PresentationObject getHandlerObject(String name, String stringValue, IWContext iwc, boolean oldGenerationHandler, String instanceId, String method) {
		try {
			DropdownMenu menu = getImportBusiness(iwc).getImportFileClasses(iwc, name);
